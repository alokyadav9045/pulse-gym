        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1 sm:mt-2">Comprehensive insights into your gym&apos;s performance</p>
            </div>
            <div className="flex gap-2 sm:gap-4">
              <select
                value={dateRange}
                onChange={(e) => setDateRange(e.target.value)}
                className="px-2 sm:px-3 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
              >
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-6">
            <div className="flex items-center flex-col sm:flex-row">
              ...
              <div className="mt-2 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <p className="text-lg sm:text-2xl font-bold text-gray-900">{reportData.totalMembers.toLocaleString()}</p>
              </div>
            </div>
          </div>
